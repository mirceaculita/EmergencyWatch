...
public class MainActivity extends AppCompatActivity implements NavigationView.OnNavigationItemSelectedListener{
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        bottomSheet = findViewById(R.id.slideup_sheet);
        ...
        floatingButton.setOnClickListener(view -> drawerLayout.openDrawer(navigationView));
        ...
        ttsNotificationManager = new TTSNotificationManager(this);
    ...
    public void updatePermanentNotification(String title, String content, int smallIconResId) {
        Intent updateNotificationIntent = new Intent(this, ForegroundActivity.class);
        ...
        startService(updateNotificationIntent);
    }
    ...
    public boolean onNavigationItemSelected(@NonNull MenuItem item) {
        ...
        if (selectedFragment != null) {
            getSupportFragmentManager()
                    .beginTransaction()
                    .replace(R.id.constraintLayoutMapView, selectedFragment)
                    .commit();
        }
